...
class PurePursuit : public rclcpp::Node {
   ...
   private:
    ...
    struct csvFileData {
        ...
        int index;
        int velocity_index;
        int publish_counter_taken_road = 0; 
        int publish_counter_desired_road = 0; 
    ...
    std::string rviz_taken_road_topic;
    std::string rviz_desired_road_topic;
    ...
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr vis_taken_road_pub;
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr vis_desired_road_pub;
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr path_publisher;
    //rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr vis_lookahead_point_pub;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr transform_info_pub;
    ...
    void taken_road_visualization(double x, double y);
    ...
    void odom_callback(const eufs_msgs::msg::CarState::ConstSharedPtr odom_submsgObj);
